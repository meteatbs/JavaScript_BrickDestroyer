...
//Create bricks array of rows brick objeler oluşturulur 
const bricks=[];
for (let i = 0; i < brickRowCount; i++) {
    ...
    for(let j=0;j<brickColumnCount;j++){
        ...
        bricks[i][j]={x,y,...brickInfo};//it take all of brickInfo properties
    }
...
//Draw bricks on canvas according to columns and rows
function drawBricks() {
